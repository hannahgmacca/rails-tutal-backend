...
TutorStudent.create(student_id: 1, tutor_id: 1)
TutorStudent.create(student_id: 2, tutor_id: 1)
Review.create(student_id: 1, tutor_id: 1, review: "Great service", rating: 5)
Review.create(student_id: 2, tutor_id: 1, review: "Terrible tutor, would never go back", rating: 1)
